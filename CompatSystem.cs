...
public class CompatSystem : ModSystem
{
    ...
    /// </summary>
    private const double CacheTimeHours = 0.166667; // 10 minutes for now
    ...
    public override void OnModLoad()
    {
        ...
        Task.Run(async () =>
        {
            ...
            var response = await client.PostAsync(GetAPIEndpoint() + "/api/check-compatibility", content);
    ...
    public class ApiMultiplayerCompatibility
    {
        ...
        [JsonPropertyName("fix_mods")]
        public ulong[] FixModIDs { get; set; }
    }
